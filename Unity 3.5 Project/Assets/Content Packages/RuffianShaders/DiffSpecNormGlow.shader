Shader "RuffianShaders/DiffSpecNormGlow"
{
	Properties 
	{
...
_Glossiness("Gloss Multiplier", Range(0.5,10) ) = 0.5
_GlowMap("Glow Texture (optional)", 2D) = "black" {}
	}
...
float4 Multiply1=Tex2D0.aaaa * _Glossiness.xxxx;
